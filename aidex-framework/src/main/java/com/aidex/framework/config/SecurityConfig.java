...
import com.aidex.common.annotation.AnonymousAccess;
import com.aidex.common.utils.spring.SpringUtils;
import com.aidex.framework.config.properties.PermitAllUrlProperties;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .antMatchers("/login", "/register", "/captchaImage", "/sendSms","/process/student","/process/student/process").anonymous()
                .antMatchers(
                        HttpMethod.GET,
                        "/",
                        "/*.html",
