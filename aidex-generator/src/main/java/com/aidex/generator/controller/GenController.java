...
import com.aidex.generator.service.IGenTableColumnService;
import com.aidex.generator.service.IGenTableService;
...
public class GenController extends BaseController
{
    ...
    @PostMapping("/editNoValidated")
    public AjaxResult editNoValidated(@RequestBody GenTable genTable)
    {
    ...
    public void download(HttpServletResponse response, @PathVariable("tableName") String tableName) throws IOException
    {
        ...
        if(CollectionUtils.isEmpty(tableList)){
            genTableService.validateEdit(tableList.get(0));
        }
    ...
    public R genCode(@PathVariable("tableName") String tableName)
    {
        ...
        return R.success(genTableService.generatorCode(tableName));
    }
    ...
    @PreAuthorize("@ss.hasPermi('tool:gen:edit')")
    @Log(title = "代码生成", businessType = BusinessType.UPDATE)
    @GetMapping("/addMenu/{tableName}")
    public AjaxResult addMenu(@PathVariable("tableName") String tableName)
    {
        genTableService.addMenu(tableName);
        return AjaxResult.success();
    }
