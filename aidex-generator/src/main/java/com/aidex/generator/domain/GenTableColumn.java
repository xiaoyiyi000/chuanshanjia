...
public class GenTableColumn extends BaseEntity
{
    ...
    public static boolean isSuperColumn(String javaField)
    {
        return StringUtils.equalsAnyIgnoreCase(javaField,
                // BaseEntity
                "id", "createBy","createDept", "createTime","updateBy","updateTime","updateIp","version", "delFlag",
                // TreeEntity
                "parentId" , "parentIds" , "treeSorts" , "treeLevel", "treeLeaf",  "children");
    }
